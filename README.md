...
23. **Offline Android versionado**: tablas locales con versionado, outbox de operaciones pendientes y registro de conflictos locales/remotos durante sync.
24. **Seguridad backend E2E**: login real (`/auth/login`), gestión de usuarios/roles (`/auth/users`) y consulta de auditoría (`/auth/audit`).
